  ...
  <div class="page-container">
    <div class="page-header">
      <div>
        ...
        <p class="page-subtitle">{{ store.clients.length }} clientes registrados</p>
      </div>
    ...
    <div class="filter-row">
      <div class="search-bar">
        ...
        <input v-model="searchQuery" placeholder="Buscar por nombre o teléfono..." />
      </div>
    </div>
      ...
      <div v-for="client in filteredClients" :key="client.id" class="client-card card">
        ...
        <div class="client-stats">
          ...
          <div class="cs-stat">
            ...
            <span class="cs-value">{{ clientSalesCount(client.id) }}</span>
          </div>
          <div class="cs-stat">
        ...
        <div class="modal-body">
          <div class="history-summary">
            ...
            <div class="hs-stat">
              ...
              <div class="hs-value">{{ clientSales.length }}</div>
            </div>
            <div class="hs-stat">
...
import { formatCurrency, formatDate, formatDateShort } from '../utils/calculations.js'
