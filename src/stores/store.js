...
function generateDemoData() {
  ...
  const clients = [
    { id: 1, name: 'Juan Pérez', phone: '3101234567', address: 'Cra 15 #20-30, Bogotá', email: 'juan@email.com', notes: 'Cliente frecuente', createdAt: new Date().toISOString(), totalBought: 0 },
    { id: 2, name: 'María García', phone: '3157654321', address: 'Cll 45 #12-10, Medellín', email: 'maria@email.com', notes: '', createdAt: new Date().toISOString(), totalBought: 0 },
    { id: 3, name: 'Carlos Rodríguez', phone: '3209876543', address: 'Av. 30 #45-67, Cali', email: '', notes: 'Mecánico de motos', createdAt: new Date().toISOString(), totalBought: 0 },
  ]
...
const store = reactive({
  ...
  // ============ SALES ============
  registerSale({ items, clientId, clientName, paymentMethod, paid, total: passedTotal, discount = 0 }) {
    ...
    const finalTotal = passedTotal !== undefined ? Math.max(0, Number(passedTotal) || 0) : Math.max(0, itemsSubtotal - finalDiscount)
  ...
  // ============ DEBTS ============
  createDebt({ saleId, clientId, clientName, total, paid, items }) {
