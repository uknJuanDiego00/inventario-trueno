  ...
  <div class="page-container">
    ...
    <div class="grid-4" style="margin-bottom:24px">
      ...
      <div class="stat-card" style="--card-color: #f5a623">
        ...
        <div class="stat-value text-warning">{{ store.lowStockProducts.length }}</div>
      ...
      <div class="stat-card">
        ...
        <div class="stat-value">{{ store.totalClients }}</div>
      ...
      <div class="stat-card">
        ...
        <div class="stat-value">{{ store.sales.length }}</div>
...
import { formatCurrency, formatDate, getWeeklySalesData, getMonthlySalesData } from '../utils/calculations.js'
import {
